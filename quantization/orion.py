...
class OrionAWQForCausalLM(BaseAWQForCausalLM):
    layer_type = "OrionDecoderLayer"
    max_new_tokens_key = "max_position_embeddings"

    @staticmethod
    def fuse_layers(model):
        fuser = OrionFuser(model)
...
class OrionFuser:
    ...
    def fuse_transformer(self):
        ...
        for module in tqdm.tqdm(self.model.model.layers, desc="Orion Fusing layers..."):
